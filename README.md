...
| `0002_rls_listings.sql` | Permisos de publicaciones y fotos; vista `perfiles_publicos` | ✅ Sí |
| `0003_storage_fotos.sql` | Bucket `fotos-items` y permisos de archivos | ✅ Sí (por SQL, sin plan B) |
